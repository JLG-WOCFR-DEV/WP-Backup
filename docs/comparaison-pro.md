...
- **Notifications multi-canales sans escalade** : l’envoi e-mail, Slack, Discord, Teams et SMS est désormais orchestré par une file dédiée avec retries exponentiels et journalisation, mais il n’existe pas encore de scénarios d’escalade ni de templates par gravité comme sur les suites pro.【F:backup-jlg/includes/class-bjlg-notifications.php†L21-L198】【F:backup-jlg/includes/class-bjlg-notification-queue.php†L360-L503】
...
| **Notifications** | Dispatcher multi-canaux (email, Slack, Discord, Teams, SMS) avec retries, historique et panneau de file d’attente depuis l’admin.【F:backup-jlg/includes/class-bjlg-notifications.php†L21-L198】【F:backup-jlg/includes/class-bjlg-notification-queue.php†L360-L503】【F:backup-jlg/includes/class-bjlg-admin.php†L899-L1061】 | Alerte en temps réel multi-canale (email, SMS, chatops) avec escalade et fenêtres de maintenance et templates par priorité.|
...
1. **Ajouter des politiques d’escalade et des templates par gravité** pour les notifications (créneaux de maintenance, relances multi-canaux, résumés synthétiques) afin d’égaler les consoles gérées.【F:backup-jlg/includes/class-bjlg-notifications.php†L21-L198】【F:backup-jlg/includes/class-bjlg-notification-queue.php†L360-L503】
...
- **Orchestrer l’escalade des notifications** : proposer des plages de silence, un plan d’escalade (email → Slack → SMS) et des messages adaptés à la gravité directement depuis l’admin.【F:backup-jlg/includes/class-bjlg-notifications.php†L21-L198】【F:backup-jlg/includes/class-bjlg-notification-queue.php†L360-L503】【F:backup-jlg/includes/class-bjlg-admin.php†L899-L1061】
...
- **Canaux d’alerte sans escalade** : l’interface admin pilote désormais email, Slack, Discord, Teams et SMS avec retries et monitoring, mais ne propose pas encore de règles d’escalade ni de plages de silence configurables comme les offres omnicanales.【F:backup-jlg/includes/class-bjlg-notifications.php†L21-L198】【F:backup-jlg/includes/class-bjlg-notification-queue.php†L360-L503】【F:backup-jlg/includes/class-bjlg-admin.php†L899-L1061】
...
3. **Monitorer la purge distante** via des indicateurs SLA (temps moyen, volumétrie restante) et déclencher alertes/escalades lorsque la file dépasse un seuil, à l’image des orchestrateurs SaaS.【F:backup-jlg/includes/class-bjlg-remote-purge-worker.php†L11-L321】【F:backup-jlg/includes/class-bjlg-admin.php†L899-L1061】
