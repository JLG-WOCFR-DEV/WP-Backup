...
- Les notifications externes reposent sur un dispatcher asynchrone multi-canaux (email, Slack, Discord, Teams, SMS) avec retries et bouton de test depuis l’interface, mais aucune stratégie d’escalade ni plage de silence n’est proposée en natif.【F:backup-jlg/includes/class-bjlg-notifications.php†L21-L198】【F:backup-jlg/includes/class-bjlg-notification-queue.php†L360-L503】【F:backup-jlg/assets/js/admin-settings.js†L1-L420】【F:backup-jlg/includes/class-bjlg-admin.php†L899-L1061】
...
- **Orchestrer les alertes multi-canales** : définir des scénarios d’escalade, des plages de silence et des templates par gravité en s’appuyant sur le dispatcher multi-canaux et la file d’attente existants.【F:backup-jlg/includes/class-bjlg-notifications.php†L21-L198】【F:backup-jlg/includes/class-bjlg-notification-queue.php†L360-L503】【F:backup-jlg/assets/js/admin-settings.js†L240-L420】
- **Documenter la purge distante** : le worker gère déjà les retries, les alertes de retard et le panneau de suivi ; la prochaine étape est de publier des métriques SLA (temps moyen, quotas distants) et d’alerter avant saturation pour égaler les solutions managées.【F:backup-jlg/includes/class-bjlg-remote-purge-worker.php†L11-L321】【F:backup-jlg/includes/class-bjlg-admin.php†L899-L1061】
