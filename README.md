...
- Les notifications externes reposent sur un dispatcher asynchrone multi-canaux (email, Slack, Discord, Teams, SMS) avec retries et bouton de test depuis l’interface ; des fenêtres de silence quotidiennes et une première étape d’escalade différée sont désormais proposées, mais il manque encore des scénarios multi-niveaux et des modèles par gravité pour rivaliser avec les suites pro.【F:backup-jlg/includes/class-bjlg-notifications.php†L21-L364】【F:backup-jlg/includes/class-bjlg-notification-queue.php†L40-L196】【F:backup-jlg/includes/class-bjlg-admin.php†L2674-L2922】【F:backup-jlg/assets/js/admin-dashboard.js†L328-L420】
