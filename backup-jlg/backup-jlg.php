...
final class BJLG_Plugin {
    ...
    private function include_files() {
        $files_to_load = [
            ...
            'destinations/interface-bjlg-destination.php',
            'destinations/class-bjlg-google-drive.php',
            'destinations/class-bjlg-dropbox.php',
            'destinations/class-bjlg-onedrive.php',
            'destinations/class-bjlg-aws-s3.php',
            'destinations/abstract-class-bjlg-s3-compatible.php',
            'destinations/class-bjlg-wasabi.php',
            'destinations/class-bjlg-sftp.php',
        ];
